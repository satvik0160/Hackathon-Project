      ...
      >
        <AnimatePresence mode="wait">
          {isOpen ? (
            ...
            <motion.div key="open" initial={{ rotate: 90, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: -90, opacity: 0 }} className="w-full h-full overflow-hidden rounded-full">
              <img src="/dhruvlogo.webp" alt="Dhruv" className="w-full h-full object-cover" />
            </motion.div>
          )}
        </AnimatePresence>
      </motion.button>
          ...
          >
            <div className="copilot-header">
              <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
                <img src="/dhruvlogo.webp" alt="Dhruv" className="w-5 h-5 object-cover rounded-full" />
