          ...
          <div className="landing-container relative z-10">
            ...
            <div className="mt-16 grid md:grid-cols-3 gap-8 relative">
              ...
              <Reveal delay={0.1} className="landing-step-card">
                ...
                <h3 className="text-xl font-medium text-slate-800 mb-3">1. Assess & Baseline</h3>
              ...
              <Reveal delay={0.2} className="landing-step-card">
                ...
                <h3 className="text-xl font-medium text-slate-800 mb-3">2. AI-Guided Growth</h3>
                <p className="text-neutral-400 text-sm leading-relaxed">
              ...
              <Reveal delay={0.3} className="landing-step-card">
                ...
                <h3 className="text-xl font-medium text-slate-800 mb-3">3. Deterministic Matching</h3>
                <p className="text-neutral-400 text-sm leading-relaxed">
            ...
            <Reveal delay={0.1}>
              <div className="flex flex-wrap justify-center gap-2 mb-8">
                <button 
                  ...
                  className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === 'students' ? 'bg-white text-black' : 'bg-white/5 text-neutral-400 hover:text-slate-800 hover:bg-white/10'}`}
                >
                ...
                <button 
                  ...
                  className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === 'industry' ? 'bg-white text-black' : 'bg-white/5 text-neutral-400 hover:text-slate-800 hover:bg-white/10'}`}
                >
                ...
                <button 
                  ...
                  className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === 'institutions' ? 'bg-white text-black' : 'bg-white/5 text-neutral-400 hover:text-slate-800 hover:bg-white/10'}`}
                >
              ...
              <div className="bg-[#f8faff]/50 border border-blue-100 rounded-3xl p-8 md:p-12 min-h-[300px] flex flex-col md:flex-row items-center overflow-hidden">
                {activeTab === 'students' && (
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid md:grid-cols-2 gap-10 items-center w-full">
                    <div>
                      <h3 className="text-2xl font-semibold text-slate-800 mb-4">Stop applying blind.</h3>
                ...
                {activeTab === 'industry' && (
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid md:grid-cols-2 gap-10 items-center w-full">
                    <div>
                      <h3 className="text-2xl font-semibold text-slate-800 mb-4">Hire on evidence, not keywords.</h3>
                      <p className="text-neutral-400 leading-relaxed mb-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-orange-600 mr-3 shrink-0" /> Real-time skill verification of candidates.</li>
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-orange-600 mr-3 shrink-0" /> Post roles and get perfectly matched shortlists.</li>
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-orange-600 mr-3 shrink-0" /> Reduce time-to-hire and interview overhead.</li>
                      </ul>
                    </div>
                    <div className="landing-tab-photo">
                      <img
                ...
                {activeTab === 'institutions' && (
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="grid md:grid-cols-2 gap-10 items-center w-full">
                    <div>
                      <h3 className="text-2xl font-semibold text-slate-800 mb-4">Fix the curriculum in real-time.</h3>
                      <p className="text-neutral-400 leading-relaxed mb-6">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-blue-600 mr-3 shrink-0" /> Macro-level student performance analytics.</li>
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-blue-600 mr-3 shrink-0" /> Live industry alignment scores.</li>
                        <li className="flex items-center text-sm text-neutral-300"><Check className="w-4 h-4 text-blue-600 mr-3 shrink-0" /> Better placement rates through early intervention.</li>
                      </ul>
                    </div>
                    <div className="landing-tab-photo">
                      <img
